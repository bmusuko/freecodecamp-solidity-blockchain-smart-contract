...
def update_front_end():
    copy_folder_to_front_end("./build", "./front_end/contracts/chain-info")

    with open("brownie-config.yaml", "r") as brownie_config:
        config_dict = yaml.load(brownie_config, Loader=yaml.FullLoader)
        with open("./front_end/contracts/brownie-config.json", "w") as brownie_config_json:
